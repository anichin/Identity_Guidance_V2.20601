...
namespace Resources {
    ...
    internal class TooltipText {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Hint: This is a simulated issuer for demonstration. In a real scenario, you would use a production quality issuer such as ADFS v2 that would be configured to use Windows Integrated Authentication. The underlying protocols will be the same..
        /// </summary>
